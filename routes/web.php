...
Route::view('/hello', 'hello', ['name' => 'Daffa']);
...
Route::get('/hello-world', function (){
    return view('hello.world', ['name' => 'Daffa']);
});
...
Route::get('/conflict/daffa', function (){
    return "Conflict Daffa Mahardika";
});
...
//    return route('redirect-hello', ['name' => 'Daffa']);
//    return url()->route('redirect-hello', ['name' => 'Daffa']);
    return \Illuminate\Support\Facades\URL::route('redirect-hello', ['name' => 'Daffa']);
});
