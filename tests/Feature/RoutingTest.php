...
class RoutingTest extends TestCase
{
    ...
    public function testRouteParameterRegex()
    {
        ...
        $this->get('/categories/Daffa')
            ->assertSeeText('404 by Programmer Zaman Now');
    }

    public function testRouteParameterOptional()
    {
        $this->get('/users/Mahardika')
            ->assertSeeText('User Mahardika');
    ...
    {
        $this->get('/conflict/daffa')
            ->assertSeeText("Conflict daffa");

        $this->get('/conflict/mahardika')
            ->assertSeeText("Conflict mahardika");
    }
